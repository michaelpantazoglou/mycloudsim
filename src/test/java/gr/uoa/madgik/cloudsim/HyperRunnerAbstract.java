 ...
 */
public abstract class HyperRunnerAbstract extends RunnerAbstract{
	...
	protected VmAllocationPolicy getVmAllocationPolicy(
		...
		else if(vmAllocationPolicyName.equals("greenrandom"))
		{
			vmAllocationPolicy = new HyperVmAllocationPolicy(
					hostList
					);
		} else {
	...
	public void setEnableOutput(boolean enableOutput) {
        HyperRunnerAbstract.enableOutput = enableOutput;
	}
